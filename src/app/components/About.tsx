export default function About() {
  return (
    <section id="about" className="bg-[#080808] text-white py-20 px-[10%]">
          ...
          <div className="about flex justify-between items-start">
            ...
            <div className="w-[40%]">
              <div className="inline-block">
                <h2 className="text-[0.875rem] font-normal text-[#FF5EC4] tracking-wide">
                  /ABOUT
                </h2>
              </div>
            </div>
            ...
            <div className="w-[65%]">
              <p className="text-[2rem] font-medium leading-[1.5] text-white">
                I help brands bring products to life in the digital world.
                With strategy, design, and storytelling woven together, I shape experiences that feel alive, memorable, and human.<br />
                No fluff — only purpose, energy, and a touch of magic.
              </p>
            </div>
          </div>
          ...
          <div className="what-i-do flex justify-between items-start">
            ...
            <div className="w-[65%]">
              <div className="flex flex-wrap items-center gap-4">
                <span className="text-[2rem] font-normal text-white uppercase tracking-wide">
                  ART DIRECTION
                </span>
                <svg
                  width="16"
