...
export function HamburgerMenu({ className }: HamburgerMenuProps) {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div className="z-[2]" style={{ width: "10.5rem" }}>
