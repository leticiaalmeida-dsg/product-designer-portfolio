...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="bg-[#080808] text-white pt-12 md:pt-24 lg:pt-28 xl:pt-32 pb-8 md:pb-20 lg:pb-24">
      <div className="container">
        ...
        <div className="space-between-layout mb-16">
          ...
          <div className="flex-1">
            ...
            >
              <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-[5rem] font-normal leading-[1]">LET&apos;S WORK</h2>
            </div>
            <div
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-[5rem] font-normal leading-[1]">TOGETHER</h2>
            </div>
          </div>
