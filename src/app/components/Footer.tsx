...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="bg-[#080808] text-white px-[10%] pt-32 pb-24">
      <div className="container mx-auto">
        ...
        <div className="flex justify-between items-start mb-16">
          ...
          <div className="flex-1">
            ...
            >
              <h2 className="text-[5.5rem] font-normal leading-[1]">LET&apos;S WORK</h2>
            </div>
            <div 
          ...
          <div className="flex-1 text-right">
            {/* Contact CTA */}
            <div className="mb-12">
              <p className="text-[0.875rem] text-[#FF5EC4] tracking-wide inline-block">DROP ME A LINE</p>
              <div className="mt-4">
                <a href="mailto:hello@leticiaalmeida.design" className="text-[1rem] font-normal hover:text-[#FF5EC4] transition-colors block">hello@leticiaalmeida.design</a>
              </div>
              <div className="mt-2">
            ...
            <div className="mb-12">
              <div className="flex items-center justify-end gap-6">
                <a href="#" className="text-white hover:text-[#FF5EC4] transition-colors">Linkedin</a>
                <a href="#" className="text-white hover:text-[#FF5EC4] transition-colors">Instagram</a>
              </div>
            </div>
